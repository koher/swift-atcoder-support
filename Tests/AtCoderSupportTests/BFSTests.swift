...
final class BFSTests: XCTestCase {
    func testBFS() {
        do { // Trees
            ...
            do {
                var r: [Int] = []
                bfs(graph: graph, startedAt: 0) { i in
                    r.append(i)
                }
            ...
            do { // Subtrees
                var r: [Int] = []
                bfs(graph: graph, startedAt: 2) { i in
                    r.append(i)
                }
            ...
            do { // Leaves
                var r: [Int] = []
                bfs(graph: graph, startedAt: 4) { i in
                    r.append(i)
                }
                XCTAssertEqual(r, [4])
            }
    ...
    func testBFSWithPrev() {
        do { // Trees
            ...
            do {
                var currents: [Int] = []
                var prevs: [Int?] = []
                bfs(graph: graph, startedAt: 0) { current, prev in
            ...
            do { // Subtrees
                var currents: [Int] = []
                var prevs: [Int?] = []
                bfs(graph: graph, startedAt: 2) { current, prev in
                    currents.append(current)
                    prevs.append(prev)
                }
            ...
            do { // Leaves
                var currents: [Int] = []
                var prevs: [Int?] = []
                bfs(graph: graph, startedAt: 4) { current, prev in
                    currents.append(current)
                    prevs.append(prev)
                }
    ...
    func testBFSWithPrevDepth() {
        do { // Trees
            ...
            do {
                ...
                var prevs: [Int?] = []
                var depths: [Int] = []
                bfs(graph: graph, startedAt: 0) { current, prev, depth in
                    currents.append(current)
                    prevs.append(prev)
                    depths.append(depth)
                }
            ...
            do { // Subtrees
                ...
                var prevs: [Int?] = []
                var depths: [Int] = []
                bfs(graph: graph, startedAt: 2) { current, prev, depth in
                    currents.append(current)
                    prevs.append(prev)
                    depths.append(depth)
                }
            ...
            do { // Leaves
                ...
                var prevs: [Int?] = []
                var depths: [Int] = []
                bfs(graph: graph, startedAt: 4) { current, prev, depth in
                    currents.append(current)
                    prevs.append(prev)
                    depths.append(depth)
                }
